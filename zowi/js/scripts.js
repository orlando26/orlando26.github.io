var e = 0;
var plt = 1;
var currenNeuron = [2, 2];
var currentNeuronText = 'Left leg'
var W1 = [
    [0.1, 0.2, 0.3],
    [0.6, 0.5, 0.4],
    [0.7, 0.8, 0.9]
...
function plotPattern() {
    ...
    var layout = {
        ...
        yaxis: {
            title: currentNeuronText + ' pattern'
        }
    }
...
function plotPhaseDiagram() {
    ...
    var plotData = [trace1];
    var title = 'Neural System Response On ' + currentNeuronText +  '.';
    var layout = {
        title: title,
        xaxis: {
            title: 'X(k)'
